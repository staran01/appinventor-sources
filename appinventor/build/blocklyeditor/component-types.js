...
,
  ...
  "methods": [{ "name": "LogError", "description": "Writes an error message to the Android system log. See the Google Android documentation for how to access the log.", "params": [{ "name": "message", "type": "text"}]},
    ...
    { "name": "ShowChooseDialog", "description": "Displays an alert with two buttons that have the specified text. If cancelable is true, there is an additional button marked CANCEL. \nWhen one of the buttons is pressed, the AfterChoosing event will be raised, where the value of \"choice\" will be the text of the buttom that was pressed, or \"Cancel\") if the CANCEL button was pressed.", "params": [{ "name": "message", "type": "text"},{ "name": "title", "type": "text"},{ "name": "button1Text", "type": "text"},{ "name": "button2Text", "type": "text"},{ "name": "cancelable", "type": "boolean"}]},
